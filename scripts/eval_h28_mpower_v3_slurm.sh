...
# ============================================================================
#SBATCH --job-name=h28_v3_mpower
#SBATCH --output=logs/eval_h28_v3_mpower_%j.out
#SBATCH --error=logs/eval_h28_v3_mpower_%j.out
...
echo "=== H28 eval on mpower ==="
python -u scripts/eval_h28_external_v3.py --dataset mpower
echo "=== Done ==="
