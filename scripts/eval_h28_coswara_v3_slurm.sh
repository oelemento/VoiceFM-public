...
# ============================================================================
#SBATCH --job-name=h28_v3_coswara
#SBATCH --output=logs/eval_h28_v3_coswara_%j.out
#SBATCH --error=logs/eval_h28_v3_coswara_%j.out
...
echo "=== H28 eval on coswara ==="
python -u scripts/eval_h28_external_v3.py --dataset coswara --seeds 44 45 46
echo "=== Done ==="
