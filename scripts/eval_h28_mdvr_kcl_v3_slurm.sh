...
# ============================================================================
#SBATCH --job-name=h28_v3_mdvr_kcl
#SBATCH --output=logs/eval_h28_v3_mdvr_kcl_%j.out
#SBATCH --error=logs/eval_h28_v3_mdvr_kcl_%j.out
...
echo "=== H28 eval on mdvr_kcl ==="
python -u scripts/eval_h28_external_v3.py --dataset mdvr_kcl
echo "=== Done ==="
