...
# ============================================================================
#SBATCH --job-name=attention_saliency_v3_whisper
#SBATCH --partition=scu-gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=02:00:00
#SBATCH --output=logs/attention_saliency_whisper_v3_%j.out
#SBATCH --error=logs/attention_saliency_whisper_v3_%j.out
...
python scripts/evaluate_attention_saliency_v3.py \
    ...
    --baseline \
    --out-dir results_v3/attention_saliency_whisper
