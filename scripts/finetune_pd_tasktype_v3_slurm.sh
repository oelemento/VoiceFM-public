...
#SBATCH --array=1-24
#SBATCH --output=logs/pd_tasktype_v3_%A_%a.out
#SBATCH --error=logs/pd_tasktype_v3_%A_%a.out

# H24b: Fine-tune PD classifier with correct task_type_ids
# sustained→786 ("Prolonged vowel"), countdown→2 ("Animal fluency")
# Same as H24 but with task-type conditioning enabled for VoiceFM
...
OUT_DIR="results_v3/mpower_pd_tasktype"
TASK_TYPE_MAP='{"sustained":786,"countdown":2}'
