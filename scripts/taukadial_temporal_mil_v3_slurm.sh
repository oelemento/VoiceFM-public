...
# ============================================================================
#SBATCH --job-name=tk_mil_v3
#SBATCH --output=logs/taukadial_temporal_mil_v3_%j.out
#SBATCH --error=logs/taukadial_temporal_mil_v3_%j.out
...
echo "=== TAUKADIAL Temporal MIL (B2AI-calibrated) ==="
