...
# ============================================================================
#SBATCH --job-name=fs_whisper_v3
#SBATCH --output=logs/eval_whisper_fewshot_v3_%j.out
#SBATCH --error=logs/eval_whisper_fewshot_v3_%j.out
...
echo "=== VoiceFM-Whisper Few-Shot Eval ==="
echo "Started: $(date)"
