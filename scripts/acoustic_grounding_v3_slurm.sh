...
# ============================================================================
#SBATCH --job-name=acoustic_grounding_v3
#SBATCH --partition=scu-gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=01:00:00
#SBATCH --output=logs/acoustic_grounding_v3_%j.out
#SBATCH --error=logs/acoustic_grounding_v3_%j.out
...
python scripts/evaluate_acoustic_grounding_v3.py \
    ...
    --baseline \
    --out-dir results_v3/acoustic_grounding \
    --batch-size 16 \
    --device cuda
